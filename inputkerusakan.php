      ...
      <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
        ...
        <form class="form-horizontal" method="post" data-toggle="validator" role="form" action="inputkerusakan.php">
          ...
          <div class="form-group has-feedback">
            <label class="control-label col-sm-2" for="idkerusakan">ID Kerusakan:</label>
            <div class="col-sm-10">
          ...
          <div class="form-group has-feedback">
            <label class="control-label col-sm-2" for="namakerusakan">Nama Kerusakan:</label>
            <div class="col-sm-10">
          ...
          <div class="form-group">
            <label class="control-label col-sm-2" for="jenishp">Jenis Smartphone:</label>
            <div class="col-sm-10">
              <select class="form-control" name="jenishp" required>
          ...
          <div class="form-group">
            <label class="control-label col-sm-2" for="caramengatasi">Cara Mengatasi:</label>
            <div class="col-sm-10">
              <textarea rows='8' class="form-control" name="caramengatasi" required></textarea>
            </div>
          </div>

          <div class="form-group">
            <label class="control-label col-sm-2" for="linkvideo">Link Video YouTube:</label>
            <div class="col-sm-10">
              <input type="url" class="form-control" name="linkvideo" placeholder="https://www.youtube.com/watch?v=xxxxxx" required>
            </div>
          </div>
          ...
          if (isset($_POST['submit'])) {
            ...
            $query = "INSERT INTO kerusakan SET 
                  idkerusakan='$idkerusakan',
                  namakerusakan='$namakerusakan',
                  jenishp='$jenishp',
                  caramengatasi='$caramengatasi',
                  linkvideo='$linkvideo'";

            $result = mysqli_query($konek_db, $query);
            if ($result) {
              echo '<script language="javascript">';
              echo 'alert("Data Berhasil disimpan"); window.location.href="daftarkerusakan.php";';
              echo '</script>';
            } else {
